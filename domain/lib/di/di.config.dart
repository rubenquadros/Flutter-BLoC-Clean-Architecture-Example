...
import '../repository/trending_repository.dart' as _i34;
import '../repository/video_repository.dart' as _i19;
import '../usecase/cast/movie_cast_use_case.dart' as _i12;
import '../usecase/cast/show_cast_use_case.dart' as _i26;
import '../usecase/details/movie_details_use_case.dart' as _i14;
import '../usecase/details/show_details_use_case.dart' as _i27;
import '../usecase/filter/movie_filter_use_case.dart' as _i16;
import '../usecase/filter/show_filter_use_case.dart' as _i28;
...
import '../usecase/movies/top_rated_movies_use_case.dart' as _i31;
import '../usecase/movies/upcoming_movies_use_case.dart' as _i37;
...
import '../usecase/shows/shows_by_genres_use_case.dart' as _i30;
import '../usecase/shows/top_rated_shows_use_case.dart' as _i32;
import '../usecase/trending/trending_movies_use_case.dart' as _i33;
import '../usecase/trending/trending_people_use_case.dart' as _i35;
import '../usecase/trending/trending_shows_use_case.dart' as _i36;
...
_i1.GetIt $initDomainGetIt(_i1.GetIt get,
  ...
  gh.factory<_i26.ShowCastUseCase>(
      () => _i26.ShowCastUseCase(get<_i13.CastRepository>()));
  gh.factory<_i27.ShowDetailsUseCase>(
      () => _i27.ShowDetailsUseCase(get<_i15.DetailsRepository>()));
  gh.factory<_i28.ShowFilterUseCase>(
      () => _i28.ShowFilterUseCase(get<_i17.FilterRepository>()));
  gh.factory<_i29.ShowTrailerUseCase>(
      () => _i29.ShowTrailerUseCase(get<_i19.VideoRepository>()));
  gh.factory<_i30.ShowsByGenresUseCase>(
      () => _i30.ShowsByGenresUseCase(get<_i4.ShowsRepository>()));
  gh.factory<_i31.TopRatedMoviesUseCase>(
      () => _i31.TopRatedMoviesUseCase(get<_i6.MoviesRepository>()));
  gh.factory<_i32.TopRatedShowsUseCase>(
      () => _i32.TopRatedShowsUseCase(get<_i4.ShowsRepository>()));
  gh.factory<_i33.TrendingMoviesUseCase>(
      () => _i33.TrendingMoviesUseCase(get<_i34.TrendingRepository>()));
  gh.factory<_i35.TrendingPeopleUseCase>(
      () => _i35.TrendingPeopleUseCase(get<_i34.TrendingRepository>()));
  gh.factory<_i36.TrendingShowsUseCase>(
      () => _i36.TrendingShowsUseCase(get<_i34.TrendingRepository>()));
  gh.factory<_i37.UpcomingMoviesUseCase>(
      () => _i37.UpcomingMoviesUseCase(get<_i6.MoviesRepository>()));
  return get;
}
