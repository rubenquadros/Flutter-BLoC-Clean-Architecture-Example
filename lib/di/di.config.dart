...
import 'package:domain/usecase/filter/movie_filter_use_case.dart' as _i18;
import 'package:domain/usecase/filter/show_filter_use_case.dart' as _i19;
...
import 'package:domain/usecase/person/person_credits_use_case.dart' as _i22;
import 'package:domain/usecase/person/person_info_use_case.dart' as _i21;
...
import 'package:domain/usecase/trending/trending_movies_use_case.dart' as _i24;
import 'package:domain/usecase/trending/trending_people_use_case.dart' as _i26;
import 'package:domain/usecase/trending/trending_shows_use_case.dart' as _i25;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i17.MoviesShowsFilterBloc>(() => _i17.MoviesShowsFilterBloc(
      get<_i18.MovieFilterUseCase>(), get<_i19.ShowFilterUseCase>()));
  gh.factory<_i20.PersonDetailsBloc>(() => _i20.PersonDetailsBloc(
      get<_i21.PersonInfoUseCase>(), get<_i22.PersonCreditsUseCase>()));
  gh.factory<_i23.TrendingBloc>(() => _i23.TrendingBloc(
      get<_i24.TrendingMoviesUseCase>(),
      get<_i25.TrendingShowsUseCase>(),
      get<_i26.TrendingPeopleUseCase>()));
  return get;
}
