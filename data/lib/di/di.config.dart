...
import 'package:domain/repository/person_repository.dart' as _i10;
import 'package:domain/repository/trending_repository.dart' as _i12;
import 'package:domain/repository/video_repository.dart' as _i14;
...
import '../repository/person_repository_impl.dart' as _i11;
import '../repository/trending_repository_impl.dart' as _i13;
...
_i1.GetIt $initDataGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i10.PersonRepository>(
      _i11.PersonRepositoryImpl(get<_i5.MoviesShowsDataSource>()));
  gh.singleton<_i12.TrendingRepository>(
      _i13.TrendingRepositoryImpl(get<_i5.MoviesShowsDataSource>()));
  gh.singleton<_i14.VideoRepository>(
      _i15.VideoRepositoryImpl(get<_i5.MoviesShowsDataSource>()));
  return get;
}
